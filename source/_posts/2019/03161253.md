...
ai:
  - 开发一款插件用于将Markdown文档中的图片上传至Aliyun OSS，并提供图片压缩、备份功能。该插件允许在编辑视图或项目中多选文件进行操作，包括单个文件、目录和整个项目，支持自定义设置如是否转换为<a>标签、图片压缩百分比等，并在上传过程中给出日志与进度条提示。
description: 开发一款插件用于将Markdown文档中的图片上传至Aliyun OSS，并提供图片压缩、备份功能。该插件允许在编辑视图或项目中多选文件进行操作，包括单个文件、目录和整个项目，支持自定义设置如是否转换为<a>标签、图片压缩百分比等，并在上传过程中给出日志与进度条提示。
---
...
![20241229154732_lQw5m47z.webp](20241229154732_lQw5m47z.webp)
![20241229154732_mtyVTw4c.webp](20241229154732_mtyVTw4c.webp)
