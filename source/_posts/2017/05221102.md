...
ai:
  - 本文记录了使用Gradle开发IntelliJ IDEA插件的入门过程，包括创建插件项目、设置build.gradle文件、添加plugin.xml等步骤。文章还分享了遇到的问题及解决方案，如Gradle路径设置和Gradle
    IntelliJ依赖的下载方法。
description: 本文记录了使用Gradle开发IntelliJ IDEA插件的入门过程，包括创建插件项目、设置build.gradle文件、添加plugin.xml等步骤。文章还分享了遇到的问题及解决方案，如Gradle路径设置和Gradle
  IntelliJ依赖的下载方法。
keywords:
  - IDEA Plugin
  - Gradle
