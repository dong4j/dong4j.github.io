...
tags:
  ...
  - Interoperability
  - Adapters
description: '常用的日志框架介绍 '
abbrlink: 10ce2820
date: 2015-03-29 00:00:00
ai:
  - 文章详细解释了SLF4J（Simple Logging Facade for Java）框架以及与其他日志框架（如Logback、Log4j和Java Util
    Logging）之间的关系。通过对比不同场景下的桥接实现，文章阐述了如何在不同的日志框架与SLF4J之间进行互操作，并强调了限制以防止循环调用导致的堆栈溢出问题。
---
