...
title: 自定义加载动画
ai:
  - 此文档详细介绍了如何在Hexo博客中自定义不同的加载动画样式。包括了配置加载动画开关、背景颜色和使用图片或自定义CSS类实现各种动画效果的方法。主要分为几个步骤：安装主题，修改加载动画源代码以与新主题兼容，调整主题配置文件来选择不同类型的动画（如小汽车、Heo张洪同款、齿轮、钢铁侠核心等），并提供了一个问题参考链接用于解决可能出现的兼容性或样式问题。文档还特别强调了在自定义加载动画时使用背景色搭配图片以达到融合效果的提示，以及加载动画开关和图片路径的配置选项。
categories: Hexo
tags:
  - Hexo
  - 主题定制
...
cover:
description: 此文档详细介绍了如何在Hexo博客中自定义不同的加载动画样式。包括了配置加载动画开关、背景颜色和使用图片或自定义CSS类实现各种动画效果的方法。主要分为几个步骤：安装主题，修改加载动画源代码以与新主题兼容，调整主题配置文件来选择不同类型的动画（如小汽车、Heo张洪同款、齿轮、钢铁侠核心等），并提供了一个问题参考链接用于解决可能出现的兼容性或样式问题。文档还特别强调了在自定义加载动画时使用背景色搭配图片以达到融合效果的提示，以及加载动画开关和图片路径的配置选项。
---

![20241229154732_lRQ5w73Q.webp](20241229154732_lRQ5w73Q.webp)
