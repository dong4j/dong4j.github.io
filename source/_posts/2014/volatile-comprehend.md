...
![image_source/2014/volatile-comprehend/16989306174667.jpg](16989306174667.webp)

被 volatile 修饰的变量,当线程需要使用这个变量时,回去主内存中读取,然后加载到自己的工作线程中,  
工作线程中的变量只是主存变量的一个拷贝,当使用完这个变量后,会刷新会主存中.

![image_source/2014/volatile-comprehend/16989306174685.jpg](16989306174685.webp)
