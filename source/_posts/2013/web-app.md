...
再次启动服务器  
![image_source/2013/web-app/1111.png](1111.webp)

然后使用自带的客户端工具进行测试  
![image_source/2013/web-app/2222.png](2222.webp)
...
![image_source/2013/web-app/3333.png](3333.webp)

还是报错, 查询资料后发现 1.8 使用了命令工具（command line client tools）默认安装 SVN 时是未安装此客户端的。  
![image_source/2013/web-app/4444.png](4444.webp)
