...
![image_source/2018/07192103/3915800D-B858-4AB4-BABD-23CCC8E72DFB.png](3915800D-B858-4AB4-BABD-23CCC8E72DFB.webp)
...
![image_source/2018/07192103/1F89EC1A-910B-4F58-B1BA-8B4ED8F1B1A8.png](1F89EC1A-910B-4F58-B1BA-8B4ED8F1B1A8.webp)
...
1. 主节点出现故障, 此时两个从节点与主节点时区连接, 主从复制失败;
   ...
   ![image_source/2018/07192103/85406409-6B92-4CE0-A282-6E67A5DBA68D.png](85406409-6B92-4CE0-A282-6E67A5DBA68D.webp)

2. 每个 Sentinel 节点通过定期监控发现主节点出现故障;

   ![image_source/2018/07192103/00FDFC3B-4DD0-4324-812B-B7FC4ED1D211.png](00FDFC3B-4DD0-4324-812B-B7FC4ED1D211.webp)

3. 多个 Sentinel 节点对主节点的故障达成一致, 选举出 sentinel-3 节点作为领导者负责故障转移;

   ![image_source/2018/07192103/212E5E3C-AB42-41B9-8DAF-61BFB3EDFC6B.png](212E5E3C-AB42-41B9-8DAF-61BFB3EDFC6B.webp)

   1. 原来的从节点 slave-1 成为新的主节点后, 更新应用方的主节点信息;
   2. 客户端命令另一个从节点 slave-2 去复制新的主节点;
   3. 待原来的主节点恢复后, 让它去复制新的主节点;

   ![image_source/2018/07192103/0151B897-8FC5-4700-8DD7-E596BAFAF002.png](0151B897-8FC5-4700-8DD7-E596BAFAF002.webp)

4. 故障转移后的结构图

   ![image_source/2018/07192103/19036242-6602-47DF-85DA-042602A80A11.png](19036242-6602-47DF-85DA-042602A80A11.webp)
...
1. 每隔 10 秒. 每个 Sentinel 节点会向主节点和从节点发送 info 命令获取最新的拓扑结构;
   ![image_source/2018/07192103/915859E8-EA7B-4A1E-BBC0-A7D1FA91C6CC.png](915859E8-EA7B-4A1E-BBC0-A7D1FA91C6CC.webp)

2. 每隔 2 秒, 每个 Sentinel 节点向 _sentinel_:hello 频道上发送该 Sentinel 节点对于主节点的判断一级当前 Sentinel 节点的信息, 同时每个
   Sentinel 节点也会订阅该频道;
   ![image_source/2018/07192103/F5B2D7CD-4E0C-4F40-BCD0-B827BC26D8F2.png](F5B2D7CD-4E0C-4F40-BCD0-B827BC26D8F2.webp)

3. 每隔 1 秒, 每个 Sentine 会向主从节点, 其他 Sentinel 节点发送 ping 命令做心跳检测, 来确保节点当前是否可达
   ![image_source/2018/07192103/8666FF6B-28E5-4F5F-B44E-0FDADBA8AE5A.png](8666FF6B-28E5-4F5F-B44E-0FDADBA8AE5A.webp)
...
![image_source/2018/07192103/F743A8AB-F913-4949-B6EE-CD35D4C532F9.png](F743A8AB-F913-4949-B6EE-CD35D4C532F9.webp)
...
![image_source/2018/07192103/109FCB47-B219-49C7-B36E-6E234765C931.png](109FCB47-B219-49C7-B36E-6E234765C931.webp)
...
![image_source/2018/07192103/A62CC675-0FA4-4A6A-B432-5CAD116B95C5.png](A62CC675-0FA4-4A6A-B432-5CAD116B95C5.webp)
...
![image_source/2018/07192103/4B44AF64-E724-4A23-A09A-297489A6F834.png](4B44AF64-E724-4A23-A09A-297489A6F834.webp)
...
![image_source/2018/07192103/1656C749-77D9-4004-971A-5E6A751AA602.png](1656C749-77D9-4004-971A-5E6A751AA602.webp)
...
![image_source/2018/07192103/6D2AAB5C-054B-4595-94C2-9BEAD0EAABAB.png](6D2AAB5C-054B-4595-94C2-9BEAD0EAABAB.webp)
...
![image_source/2018/07192103/0652C208-B9C1-4505-92BB-C1BFBC09E9C4.png](0652C208-B9C1-4505-92BB-C1BFBC09E9C4.webp)
