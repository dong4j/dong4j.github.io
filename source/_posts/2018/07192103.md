...
![20241229154732_wkmt6CrY.webp](20241229154732_wkmt6CrY.webp)
...
![20241229154732_g8KXigVF.webp](20241229154732_g8KXigVF.webp)
...
1. 主节点出现故障, 此时两个从节点与主节点时区连接, 主从复制失败;
   ...
   ![20241229154732_yV32SN5g.webp](20241229154732_yV32SN5g.webp)

2. 每个 Sentinel 节点通过定期监控发现主节点出现故障;

   ![20241229154732_dmt2MfIR.webp](20241229154732_dmt2MfIR.webp)

3. 多个 Sentinel 节点对主节点的故障达成一致, 选举出 sentinel-3 节点作为领导者负责故障转移;

   ![20241229154732_ypMc084g.webp](20241229154732_ypMc084g.webp)

   1. 原来的从节点 slave-1 成为新的主节点后, 更新应用方的主节点信息;
   2. 客户端命令另一个从节点 slave-2 去复制新的主节点;
   3. 待原来的主节点恢复后, 让它去复制新的主节点;

   ![20241229154732_ZvDNSolX.webp](20241229154732_ZvDNSolX.webp)

4. 故障转移后的结构图

   ![20241229154732_8ZiZco7l.webp](20241229154732_8ZiZco7l.webp)
...
1. 每隔 10 秒. 每个 Sentinel 节点会向主节点和从节点发送 info 命令获取最新的拓扑结构;
   ![20241229154732_g9I5S7TW.webp](20241229154732_g9I5S7TW.webp)

2. 每隔 2 秒, 每个 Sentinel 节点向 _sentinel_:hello 频道上发送该 Sentinel 节点对于主节点的判断一级当前 Sentinel 节点的信息, 同时每个
   Sentinel 节点也会订阅该频道;
   ![20241229154732_ug9RgBvu.webp](20241229154732_ug9RgBvu.webp)

3. 每隔 1 秒, 每个 Sentine 会向主从节点, 其他 Sentinel 节点发送 ping 命令做心跳检测, 来确保节点当前是否可达
   ![20241229154732_OuXnSfQM.webp](20241229154732_OuXnSfQM.webp)
...
![20241229154732_7Uguxxes.webp](20241229154732_7Uguxxes.webp)
...
![20241229154732_ZsDsOhqv.webp](20241229154732_ZsDsOhqv.webp)
...
![20241229154732_MofUCgDd.webp](20241229154732_MofUCgDd.webp)
...
![20241229154732_zCpl5IS6.webp](20241229154732_zCpl5IS6.webp)
...
![20241229154732_iGgNGxWd.webp](20241229154732_iGgNGxWd.webp)
...
![20241229154732_Co7PVXld.webp](20241229154732_Co7PVXld.webp)
...
![20241229154732_smjFqOxg.webp](20241229154732_smjFqOxg.webp)
