...
ai:
  - 本文档详细介绍了关于日志编码规范、使用方式和注意事项，并提供了改进策略。主要包括统一的日志获取方法、正确记录异常堆栈信息、避免重复记录日志、禁止系统打印语句与printStackTrace、迁移到slf4j以优化运行效率，以及在循环中合理处理错误等关键点。文档还强调了遵守基本的日志编码规范和使用占位符代替连接符的重要性。
description: 本文档详细介绍了关于日志编码规范、使用方式和注意事项，并提供了改进策略。主要包括统一的日志获取方法、正确记录异常堆栈信息、避免重复记录日志、禁止系统打印语句与printStackTrace、迁移到slf4j以优化运行效率，以及在循环中合理处理错误等关键点。文档还强调了遵守基本的日志编码规范和使用占位符代替连接符的重要性。
---
...
![20241229154732_GNaVfMic.webp](20241229154732_GNaVfMic.webp)
...
![20241229154732_orhs0nZm.webp](20241229154732_orhs0nZm.webp)
