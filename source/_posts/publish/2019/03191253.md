...
tags:
  ...
  - APIs
  - Editor UI
  - Psi File System Integration
abbrlink: 8366ec74
date: 2019-03-19 00:00:00
ai:
  - 本文详细解释了在JetBrains IDE平台中使用的核心API和工具。涵盖的主题包括：文件系统（如获取文件、创建目录、读取文本等）、代码编辑（通过Editor
    API进行文本操作、获取文件结构信息）以及项目管理（利用DataKeys、DataContext及AnActionEvent理解上下文）。此外，文章还强调了如何与Psi（Parseable
    Symbol Interface）和语言特定API（如获取类的继承者、查找包、方法覆盖等）交互。该内容对于构建IDE集成工具或扩展非常有用。
description: 本文详细解释了在JetBrains IDE平台中使用的核心API和工具。涵盖的主题包括：文件系统（如获取文件、创建目录、读取文本等）、代码编辑（通过Editor
  API进行文本操作、获取文件结构信息）以及项目管理（利用DataKeys、DataContext及AnActionEvent理解上下文）。此外，文章还强调了如何与Psi（Parseable
  Symbol Interface）和语言特定API（如获取类的继承者、查找包、方法覆盖等）交互。该内容对于构建IDE集成工具或扩展非常有用。
---
...
![20241229154732_TaWCxR2c.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_TaWCxR2c.webp)
...
![20241229154732_qtx1O6IU.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_qtx1O6IU.webp)
...
![20241229154732_QSKPhUZG.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_QSKPhUZG.webp)
