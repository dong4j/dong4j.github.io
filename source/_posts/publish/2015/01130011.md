...
tags:
  ...
  - 内省
  - 与其他语言交互
description: 总结一下 Java 常用代码
abbrlink: b3298821
date: 2015-01-05 00:00:00
ai:
  - 本文全面覆盖了Java语言的基础到进阶知识，涵盖了从类和对象、封装、继承、多态等面向对象编程的核心概念，到异常处理、I/O操作、线程管理、反射、命令执行等功能性话题。内容还包括了与其他编程语言的结合使用案例，以及Java的高级特性如Jython和JNI。文章以详细代码示例说明了这些概念和功能的应用，并提供了关于如何在控制台中执行CMD命令以及调用非Java语言程序（如C++）的方法。
---
