...
tags:
  ...
  - 单元测试
  - 编程实践
description: 'JUnit 是一个开放源代码的 Java 测试框架, 用于编写和运行可重复的测试. 他是用于单元测试框架体系xUnit的一个实例（用于java语言）. '
abbrlink: 64d008b
date: 2015-01-13 00:00:00
ai:
  - 这是一个关于单元测试在不同版本Junit（3.x和4.x）中的应用和技术指南的文章。文章详细介绍了如何使用Junit进行单元测试，包括测试方法命名规则、测试类继承方式、使用不同的注解进行测试方法的控制与管理，以及全局初始化和销毁过程等关键点。它强调了测试的独立性、执行顺序和时间限制的重要性，并提供了示例代码以帮助理解和应用这些概念。
---
...
![20241229154732_DLDvtPTF.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_DLDvtPTF.webp)

4. 选中我们要测试的类的类名, 然后 Ctrl+shift+t --> Create new test
5. 选择 Junit4, 然后选择要测试的类的方法 (method), setUp 和 tearDown 后面再介绍

![20241229154732_Jghwc7S9.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_Jghwc7S9.webp)
...
![20241229154732_fWUaDcLs.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_fWUaDcLs.webp)
...
![20241229154732_YCpaDQtm.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_YCpaDQtm.webp)
...
4. 我们完全可以不使用 Junit 提供的这个方法
   ![20241229154732_AxkWTz3W.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_AxkWTz3W.webp)
...
![20241229154732_kSvPKuvR.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_kSvPKuvR.webp)

![20241229154732_nU9WauPf.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_nU9WauPf.webp)
...
![20241229154732_Lt3nYDKp.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_Lt3nYDKp.webp)

下面是具体的测试结果:

![20241229154732_kaHthhOm.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_kaHthhOm.webp)
...
![20241229154732_B5IRCONd.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_B5IRCONd.webp)
