...
tags:
  ...
  - Java编程
  - 面向对象
description: 创建型模式之抽象工厂模式
abbrlink: 9b7d6e62
date: 2017-01-19 00:00:00
ai:
  - 这篇文档详细解释了工厂模式的概念、类型和应用实例。它涵盖了简单工厂模式、抽象工厂模式以及具体工厂模式，并通过图片和代码示例进行了深入讲解。这些模式在软件设计中用于创建对象而无需暴露创建细节，有助于提高代码的可重用性和灵活性。简单工厂模式提供了静态方法来生成特定类型的对象，适用于具有固定数量且不需要类继承结构的产品类别。抽象工厂模式则构建出不同产品族的对象集，并允许使用通用接口处理它们，使得客户端可以操作不同的子系统而不需了解其内部实现细节。具体工厂模式进一步细化，为不同的产品等级创建多个具体的工厂类，提供更多的灵活性和控制能力。
---
...
![20241229154732_SWFLolwS.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_SWFLolwS.webp)
...
![20241229154732_wBzkJ0LQ.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_wBzkJ0LQ.webp)

使用工厂方法模式 UML 结构

![20241229154732_kZpVcxk4.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_kZpVcxk4.webp)
...
![20241229154732_ryqmwULr.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_ryqmwULr.webp)
...
![20241229154732_dnsOOLUh.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_dnsOOLUh.webp)
