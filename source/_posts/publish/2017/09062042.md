...
tags:
  ...
  - Vagrant
  - Docker
description: zheng 框架解析 (一)
abbrlink: 508e9afc
date: 2017-07-02 00:00:00
ai:
  - 文章详细描述了如何构建并部署Zheng框架的项目。作者首先通过安装Nginx、Redis和RabbitMQ来创建一个运行环境，并使用Docker进行服务的管理。接着，对Spring
    Cloud Alibaba框架的各个模块如服务中心（Upms）、微服务RPC接口中心（CMS）等进行了搭建。文章还提到了一些细节处理，例如在Windows系统中处理BOM字节序标记以确保文件内容正确读取，以及配置Nginx反向代理服务进行项目部署。由于时间紧迫，作者决定暂时不深入代码阅读和理解，而是将此作为后续的学习任务。最后，文章表达了对Zheng哥（即框架的开发者）的感谢，并表示可能在未来使用Vagrant或Docker等工具来简化环境搭建过程。
---
...
![20241229154732_BGyuUh4B.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_BGyuUh4B.webp)

clone 项目, 使用 Intellji IDEA 导入这些就不说了

这步完成的样子是这样的

![20241229154732_yKJSQxsX.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_yKJSQxsX.webp)
...
![20241229154732_FpAPd2IP.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_FpAPd2IP.webp)
...
![20241229154732_pW5gOynv.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_pW5gOynv.webp)
...
![2.gif](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/2.gif)

胡悠我, 打开的全是占位符的配置文件, 还要去找主配置才行, 然后一个一个的改? you are so young so simple

全局替换, 秒秒钟的事

![3.gif](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/3.gif)
...
![20241229154732_258FNQfX.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_258FNQfX.webp)
...
![20241229154732_sP9iBIVK.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_sP9iBIVK.webp)
![20241229154732_iLxiIuNt.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_iLxiIuNt.webp)

![20241229154732_JzTMDdjk.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_JzTMDdjk.webp)
...
![20241229154732_zO1CRq26.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_zO1CRq26.webp)

![20241229154732_toybalCB.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_toybalCB.webp)
