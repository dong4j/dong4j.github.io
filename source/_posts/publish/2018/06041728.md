...
ai:
  - 本文介绍了在优化内存性能时使用BloomFilter替代DataCache以及及时清理占用大内存临时变量的方法。在优化前后的对比中，通过调整JVM参数和引入BloomFilter，减少了处理时间和内存消耗，并提高了系统运行效率。优化方案包括采用布隆过滤器作为数据存储方式，这能够有效减少空间需求和查询时间，同时减少了垃圾对象的生成，有助于提高GC性能。
---
...
![20241229154732_ky3i189B.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_ky3i189B.webp)

持续运行一段时间, 并且使用相同的号码包进行测试的结果

发生了 OOM

![20241229154732_jpeRRWzH.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_jpeRRWzH.webp)
...
![20241229154732_898V9sAS.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_898V9sAS.webp)

持续运行一段时间, 并且使用相同的号码包进行测试的结果

![20241229154732_sb34vgzR.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_sb34vgzR.webp)
...
![20241229154732_PYx6qUxn.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_PYx6qUxn.webp)
