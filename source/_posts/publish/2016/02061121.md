...
ai:
  - 本文详细介绍了在不同的队列容量设置（SynchronousQueue 和 LinkedBlockingQueue）和最大线程数配置下，使用Java中的ThreadPoolExecutor创建多线程任务时的行为。包括核心线程、非核心线程、队列满时的处理方式以及添加任务时可能出现的异常情况。通过实例代码展示了当队列已满或达到最大线程数时，如何抛出RejectedExecutionException，并解释了其中的原因。
description: 本文详细介绍了在不同的队列容量设置（SynchronousQueue 和 LinkedBlockingQueue）和最大线程数配置下，使用Java中的ThreadPoolExecutor创建多线程任务时的行为。包括核心线程、非核心线程、队列满时的处理方式以及添加任务时可能出现的异常情况。通过实例代码展示了当队列已满或达到最大线程数时，如何抛出RejectedExecutionException，并解释了其中的原因。
---
...
![20241229154732_0gAWOlv1.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_0gAWOlv1.webp)
...
![20241229154732_MPBClhGO.webp](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/20241229154732_MPBClhGO.webp)
...
![死循环懵逼.gif](https://blog-1258270892.cos.ap-chengdu.myqcloud.com/source/image/%E6%AD%BB%E5%BE%AA%E7%8E%AF%E6%87%B5%E9%80%BC.gif)
