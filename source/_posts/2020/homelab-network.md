...
cover: /images/cover/homelab-network.webp
swiper_index: 4
top_group_index: 4
ai: true
tags:
...
![封面图](/images/cover/homelab-network.webp)
...
2. 使用电力猫连接 IPTV 电视盒子, 网线连接无线路由器, 这种方式会导致 IPTV 电视信号稳定性不高;
   ...
   ![image_source/2020/homelab-network/电力猫.png](电力猫.webp)

3. 单线复用: 使用支持 VLAN 的交换机, 划分两个逻辑独立的网络. 这种连接方式会增加配置复杂度. [这里有详细的视频教程](https://www.youtube.com/watch?v=1CuyE5HXhA8)

   ![image_source/2020/homelab-network/电线复用.png](电线复用.webp)

### 弱电箱

![image_source/2020/homelab-network/弱电箱.jpg](弱电箱.webp)
...
![image_source/2020/homelab-network/入口.jpg](入口.webp)
...
![image_source/2020/homelab-network/走线图.jpg](走线图.webp)
...
![image_source/2020/homelab-network/20241117_eHckEkKC.png](20241117_eHckEkKC.webp)

**联通**:

![image_source/2020/homelab-network/20241117_p9tVr4ct.png](20241117_p9tVr4ct.webp)

### 内网

内网主要设备全部实现 2.5G:

![image_source/2020/homelab-network/20241117_J9M8SVNo.png](20241117_J9M8SVNo.webp)

通过雷雳 3 直连的 2 台 Mac mini 能达到 20G:

![image_source/2020/homelab-network/20241117_Qh6Tp2Is.png](20241117_Qh6Tp2Is.webp)

通过万兆交换机连接的 Mac mini 2018 和 DS923+ 能达到 10G 速度:

![image_source/2020/homelab-network/20241117_pxN83QyM.png](20241117_pxN83QyM.webp)

### 外网->家

![image_source/2020/homelab-network/20241117_RgD2AITl.png](20241117_RgD2AITl.webp)

给一个逆天的网速测试截图, 就当图了乐 🤩:

![image_source/2020/homelab-network/20241119_wwGkLJQb.png](20241119_wwGkLJQb.webp)
...
![image_source/2020/homelab-network/20241119_CdYgiFk3.png](20241119_CdYgiFk3.webp)
...
![image_source/2020/homelab-network/20241119_w20Qf0uC.png](20241119_w20Qf0uC.webp)
...
![SSH-LocalForward.svg](SSH-LocalForward.drawio.svg)
...
![image_source/2020/homelab-network/20241119_QyQ216fw.png](20241119_QyQ216fw.webp)
...
![SSH-LocalForward.svg](SSH-RemoteForward.drawio.svg)
...
![image_source/2020/homelab-network/20241119_Ix9as6sc.png](20241119_Ix9as6sc.webp)
...
![image_source/2020/homelab-network/20241119210107.png](20241119210107.webp)
...
![image_source/2020/homelab-network/20241118_ntcdvtCf.png](20241118_ntcdvtCf.webp)
...
![image_source/2020/homelab-network/20241120_1L1YRvFN.png](20241120_1L1YRvFN.webp)

你一个比较惊喜的功能就是: `Broadcast Input to all Terminal Sessions`, 开启多个窗口, 在一台服务器上的操作会同步输出到其他服务器, 这个可以大大简化服务器的配置工作.

**简洁的 SSH 转发设置**:

![image_source/2020/homelab-network/20241120_xB17hzkF.png](20241120_xB17hzkF.webp)

**串口连接**:

![image_source/2020/homelab-network/20241120_TObYyBMX.png](20241120_TObYyBMX.webp)

但是 **Royal TSX** 也有它的不足, 比如 **文件管理不方便**, RDP 连接分辨率无法动态适配等, 所以我使用了另一款工具: **XTerminal**, 它的优点是文件管理和系统监控, 亮点是基于 AI 的命令行提示.

![image_source/2020/homelab-network/20241120_NWyknxGi.png](20241120_NWyknxGi.webp)
...
![image_source/2020/homelab-network/20241120_cdftZHBF.png](20241120_cdftZHBF.webp)

**可视化的 SSH 端口转发配置**:

![image_source/2020/homelab-network/20241120_o7XEgNAJ.png](20241120_o7XEgNAJ.webp)
...
![image_source/2020/homelab-network/20241120_SCf0VkYQ.png](20241120_SCf0VkYQ.webp)

{% details  🪬 如何删除 thinclient_drives %}
...
![image_source/2020/homelab-network/20241120_PzbDJnkP.png](20241120_PzbDJnkP.webp)

{% details  🪬 Ubuntu 远程桌面每次重启后 VNC 密码改变的解决方式 %}
...
![image_source/2020/homelab-network/1*kQKnGj4OsD6bMjNCgDELrg.png](1*kQKnGj4OsD6bMjNCgDELrg.webp)

![image_source/2020/homelab-network/1*n3h_DhIEyawvaGH9wF1O4A.png](1*n3h_DhIEyawvaGH9wF1O4A.webp)
...
![image_source/2020/homelab-network/20241118_fRQ1Rls1.png](20241118_fRQ1Rls1.webp)
...
6. 通过网卡获取 IPv6
   ...
   ![image_source/2020/homelab-network/20241118_ZTa5CjmS.png](20241118_ZTa5CjmS.webp)
...
7. ddns-go 启动前 10 分钟(具体几分钟记不得了, 反正越快越好)才能设置账号密码
   ...
   ![image_source/2020/homelab-network/20241118_2Hq9HZxg.png](20241118_2Hq9HZxg.webp)

最好禁用公网访问, 这样只能通过局域网 IP 访问.

8. ddns-go 可以配置 IP 变更通知, 我使用的是 [bark](https://bark.day.app/#/) 服务, 全平台可用, 且服务也能自托管:

   ![image_source/2020/homelab-network/20241118_K6bcmFk0.png](20241118_K6bcmFk0.webp)
...
![image_source/2020/homelab-network/20241118_x1kOdW3Q.png](20241118_x1kOdW3Q.webp)
...
![image_source/2020/homelab-network/20241118_kJVujOpK.png](20241118_kJVujOpK.webp)

**为了安全起见, 已将所有服务迁移到 雷池 Safeline**.

#### 反向代理

![image_source/2020/homelab-network/20241118_m4l61SmG.png](20241118_m4l61SmG.webp)
...
- 在 `NPM` 添加代理服务配置:
  ...
  ![image_source/2020/homelab-network/20241118_HO7kTwU6.png](20241118_HO7kTwU6.webp)

访问 `nas.dong4j.tele:1020` 即可访问 NAS 的 WebUI 服务.

![NPM.drawio](NPM-HTTP.drawio.svg)
...
![NPM.drawio](NPM-HTTPS.drawio.svg)
...
![image_source/2020/homelab-network/20241118_qzUDTlco.png](20241118_qzUDTlco.webp)
...
![NPM_Surge_proxy.drawio](NPM_Surge_proxy.drawio.svg)
...
2. 配置 NPM:
   ...
   ![image_source/2020/homelab-network/20241120_hbEaODIu.png](20241120_hbEaODIu.webp)
...
![image_source/2020/homelab-network/20241120_yaAdpDbq.png](20241120_yaAdpDbq.webp)
...
![image_source/2020/homelab-network/20241118_SszplDYd.png](20241118_SszplDYd.webp)

1Panel 的证书申请非常快且成功率 100%, 可以采用手动的方式为 **雷池 Safeline** 添加证书, 也可以 [自动化部署 HTTPS 证书到 WAF](#自动部署 1Panel 申请的 HTTPS).

![image_source/2020/homelab-network/20241119_irfeBFFU.png](20241119_irfeBFFU.webp)

### 雷池 Safeline

[雷池](https://waf-ce.chaitin.cn/) 号称 **下一代 Web 应用防火墙**, 社区版功能完全够用(主要因为专业版太贵 🥲), 专业版多了告警, 负载均衡等功能:

![image_source/2020/homelab-network/20241119_FmgH1a2x.png](20241119_FmgH1a2x.webp)

用 [官方的测试工具](https://github.com/chaitin/blazehttp) 玩了一下, 攻击检测日志中的信息非常全面:

![image_source/2020/homelab-network/20241120_KM710JaE.png](20241120_KM710JaE.webp)

且还有 AI 攻击分析:

![image_source/2020/homelab-network/20241120_14yrH4Vr.png](20241120_14yrH4Vr.webp)
...
![image_source/2020/homelab-network/20241119_IAb0f1Mq.png](20241119_IAb0f1Mq.webp)

![image_source/2020/homelab-network/20241119_jcpLubfy.png](20241119_jcpLubfy.webp)
...
![image_source/2020/homelab-network/20241121_WXBkJfqS.png](20241121_WXBkJfqS.webp)
...
![image_source/2020/homelab-network/20200702153436-2349251.png](20200702153436-2349251.webp)

熟悉 Synology 的朋友都知道 `5000` 是 NAS 的 WebUI 的 HTTP 端口. 接着在路由器上配置端口转发, 将 `1443` 转发到 `192.168.31.10:1443`,

然后在手机客户端上登录:

![image_source/2020/homelab-network/20241121_QxGfYlK2.png](20241121_QxGfYlK2.webp)
...
![image_source/2020/homelab-network/20241121_DIsjWEwh.png](20241121_DIsjWEwh.webp)

所以为了让桌面版的 Drive client 能正常使用, 我们需要在路由器上多配置一个端口转发规则 ([因为 WAF 它不支持 TCP/UDP 转发](#WAF 的代理的局限性)):

![image_source/2020/homelab-network/20241121_jCZ1MvFp.png](20241121_jCZ1MvFp.webp)

桌面版 Drive 连接配置:

![image_source/2020/homelab-network/20241121_2coUKqpa.png](20241121_2coUKqpa.webp)
...
2. 新增证书-导入证书或从 Let's Encrypt 获取证书 (如果是更新证书就选第二项: **替换已有证书**)-导入证书(不要勾选 **设为默认证书**[如果你知道是什么操作可执行选择]):
   ...
   ![image_source/2020/homelab-network/20241121_uVA13RyX.png](20241121_uVA13RyX.webp)
...
3. 为 Drive 配置自定义证书:
   ...
   ![image_source/2020/homelab-network/20241121_Tr6AMkSE.png](20241121_Tr6AMkSE.webp)
...
![image_source/2020/homelab-network/20241120_h6Nluma1.png](20241120_h6Nluma1.webp)
...
![image_source/2020/homelab-network/20241121_OVy3SHlL.png](20241121_OVy3SHlL.webp)
...
![image_source/2020/homelab-network/20241120_rOAxcYww.png](20241120_rOAxcYww.webp)
...
1. 在 1Panel 上配置 **推送证书到本地目录**:
   ...
   ![image_source/2020/homelab-network/20241120_GLC69x2Y.png](20241120_GLC69x2Y.webp)

如果原来没有配置证书推送, 需要重新申请一次:

![image_source/2020/homelab-network/20241120_rf1EjZyr.png](20241120_rf1EjZyr.webp)
...
![image_source/2020/homelab-network/20241120_jpHonUqX.png](20241120_jpHonUqX.webp)

最后在 1Panel 中重新申请证书即可:

![image_source/2020/homelab-network/20241120_RbCcFqdV.png](20241120_RbCcFqdV.webp)
...
{% details  🪬 查看 reset_tengine.sh 脚本内容 %}
...
![image_source/2020/homelab-network/20241120_wIeRWFuZ.png](20241120_wIeRWFuZ.webp)
...
{% details  🪬 查看 update_certs.sh 脚本内容 %}
...
>
> ![image_source/2020/homelab-network/20241122_GsVYR0H0.png](20241122_GsVYR0H0.webp)
...
![image_source/2020/homelab-network/20241121_Gk6dnk46.png](20241121_Gk6dnk46.webp)
...
![auto-switch-hosts.drawio](auto-switch-hosts.drawio.svg)
...
![image_source/2020/homelab-network/20241121_6cApnHey.png](20241121_6cApnHey.webp)

WAF 的代理配置:

![image_source/2020/homelab-network/20241121_mA0vbr22.png](20241121_mA0vbr22.webp)
...
4. 开启 WiFi, 访问一下 `https://nas.dong4j.tele:1234` :
   ...
   ![image_source/2020/homelab-network/20241121_WHSBQtmN.png](20241121_WHSBQtmN.webp)
...
![image_source/2020/homelab-network/20241121_C7YVMGhl.png](20241121_C7YVMGhl.webp)

添加一个站点:

![image_source/2020/homelab-network/20241121_ndADouCX.png](20241121_ndADouCX.webp)

配置 HTTPS:

![image_source/2020/homelab-network/20241121_n7xrNNQE.png](20241121_n7xrNNQE.webp)
...
![image_source/2020/homelab-network/20241121_wuWfwbKg.png](20241121_wuWfwbKg.webp)
...
![image_source/2020/homelab-network/20241122_A7F7leJT.png](20241122_A7F7leJT.webp)
...
![image_source/2020/homelab-network/20241122_bZsmvrbO.png](20241122_bZsmvrbO.webp)

**AdGuard Home** 同样提供手机客户端.

因为是旁路由模式, 所以需要手动为客户端设置网关和 DNS:

![image_source/2020/homelab-network/image-20241122164838843-2265362.png](image-20241122164838843-2265362.webp)
...
在开始这章之前, 有必要了解一下 {% post_link nat-guide 'NAT (Network Address Translation) ' %} <!-- 链接站内文章, 使用文件名, 不要后缀 -->
...
![image_source/2020/homelab-network/20241123_FbL7SGsD-2347879.png](20241123_FbL7SGsD-2347879.webp)
...
![image_source/2020/homelab-network/20241123_USx1To3q.png](20241123_USx1To3q.webp)
...
![image_source/2020/homelab-network/20241123_tJC3kP4Y-2347960.png](20241123_tJC3kP4Y-2347960.webp)
...
![image_source/2020/homelab-network/20241123_LD7ZawsV.png](20241123_LD7ZawsV.webp)
...
![image_source/2020/homelab-network/20200702153436-2349258.png](20200702153436-2349258.webp)
...
- **精简且速度极快**: 仅由 4000 行代码组成, 是所有协议中“最精简”的协议. 相较之下, OpenVPN 代码行数是它的 100 倍.
  ...
  ![image_source/2020/homelab-network/20241123_6evGGqJB-2348439-2348779.png](20241123_6evGGqJB-2348439-2348779.webp)
...
上面也提到了, 当通信双方都在 NAT 后面的时候, 直接连接不太现实, 因为大多数 NAT 路由器对源端口的随机化相当严格, 不可能提前为双方协调一个固定开放的端口. 必须使用一个信令服务器 (`STUN `, {% post_link nat-guide '自建 STUN Server?' %}) , 它会在中间沟通分配给对方哪些随机源端口. 通信双方都会和公共信令服务器进行初始连接, 然后它记录下随机的源端口, 并将其返回给客户端.
...
![image_source/2020/homelab-network/20241125_C1TCOu0v.png](20241125_C1TCOu0v.webp)
...
![image_source/2020/homelab-network/20241125_aQLkPWn5.png](20241125_aQLkPWn5.webp)

也能成功访问 M920x 上的服务:

![image_source/2020/homelab-network/20241125_hRapPwF6.png](20241125_hRapPwF6.webp)

在 **M920x** 上使用 **wg** 查看 **WireGuard** 信息:

![image_source/2020/homelab-network/20241125_UTk4JwOY.png](20241125_UTk4JwOY.webp)
...
![](ubuntu-wireguard-double.drawio.svg)
...
![image_source/2020/homelab-network/20241125_ZPcHGnwg.png](20241125_ZPcHGnwg.webp)
...
![image_source/2020/homelab-network/20241124_818ghsGO.png](20241124_818ghsGO.webp)

在 **网络-接口** 选项卡下新增一个 **WireGuard** 接口:

![image_source/2020/homelab-network/20241124_8THxObpE.png](20241124_8THxObpE.webp)

> 在某些 **OpenWrt** 系统中, 只能添加一个 **WireGuard** 接口, 比如 NanoPI 的 FriendlyWrt, 推荐你早点换掉, 不然后面无法玩儿更多的功能.

![image_source/2020/homelab-network/20241125_valgzf8V.png](20241125_valgzf8V.webp)

只需要填写 **私钥**, **监听端口** 和 IP 地址即可.

![image_source/2020/homelab-network/20241125_QiN84pr8.png](20241125_QiN84pr8.webp)

只需要填写 **公钥**, **允许的 IP**, **勾选路由允许的 IP** 即可, 其他 3 个可以在客户端配置上修改.

最后是配置防火墙, 允许 **51000** 进出即可(因为我把 **WireGuard_Test** 划分到 wan 区域了, 所以这里是 **wan**).

![image_source/2020/homelab-network/20241125_7BBkRJ8y.png](20241125_7BBkRJ8y.webp)

配置完成后, 最好重启一下 **WireGuard_Test** 接口, 最后配置客户端即可可到状态:

![image_source/2020/homelab-network/20241125_nrOKA645.png](20241125_nrOKA645.webp)
...
![image_source/2020/homelab-network/20241124_Eymp2VvU.png](20241124_Eymp2VvU.webp)
...
看过 {% post_link nat-guide 'NAT (Network Address Translation) ' %} 之后肯定清楚打洞的原理, 只要隧道被打通后, 在 NAT 记录失效之前(UDP 约 30 秒)更新 **WireGuard** 的配置并建立连接就可以直接通信, 实现细节可以参考这篇博客: [WireGuard Endpoint Discovery and NAT Traversal using DNS-SD](https://www.jordanwhited.com/posts/wireguard-endpoint-discovery-nat-traversal/), 很有启发意义.
...
![image_source/2020/homelab-network/20241128_cOjZoZV1.png](20241128_cOjZoZV1.webp)
