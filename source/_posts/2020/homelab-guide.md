...
cover: /images/cover/homelab-guide.webp
sticky: 1
swiper_index: 2
top_group_index: 2
ai: true
...
![封面图](/images/cover/homelab-guide.webp)
...
1. {% post_link homelab-hardware '硬件篇' %} ：介绍我所拥有的硬件设备;
2. {% post_link homelab-network '网络篇' %} ：包括网络环境、异地组网与网络安全;
3. {% post_link homelab-service '服务篇' %} ：使用 Docker 搭建的各类服务;
4. {% post_link homelab-data '数据篇' %} ：包括数据存储方案、备份方案和数据恢复方案;
5. {% post_link homelab-data-sync 'HomeLab数据同步：构建高效的数据同步网络' %};
6. {% post_link homelab-data-backup 'HomeLab数据备份：打造坚实的数据安全防线' %};
...
![image_source/2020/homelab-guide/2.jpg](2.webp)

![image_source/2020/homelab-guide/3.jpg](3.webp)
...
![image_source/2020/homelab-guide/4.png](4.webp)

大部分服务使用 Docker 搭建，因此选择设备的刚性条件就是：是否支持虚拟化。

## 数据存储与备份

![image_source/2020/homelab-guide/5.png](5.webp)
