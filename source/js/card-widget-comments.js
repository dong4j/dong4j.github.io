(() => {
  ...
  const LatestComments = {
    ...
    ADMIN_EMAIL_MD5:
      "3435c7a74ba1cad3f5d57b0b61b9b25cee221b97599c47b32edbdb36038c5411",
    PAGE_SIZE: 5,
    ...
    getErrorTemplate(icon, message) {
      return `
          <div style="min-height: 346px;display: flex;padding: 20px;text-align: center;justify-content: center;align-items: center;flex-direction: column;">
            <i class="fas fa-${icon}" style="font-size: 2rem; color: ${
        icon === "exclamation-circle" ? "#ff6b6b" : "#999"
    ...
    async insertComponent() {
      ...
      container.innerHTML = `<div style="display: flex; justify-content: center; align-items: center; background-color: #f9f9f9; border-radius: 8px; overflow: hidden; width: 100%; max-width: 300px; max-height: 300px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);"><img src="${this.LOADING_GIF}" style="width: auto; height: 100%; object-fit: contain;"></div>`;
