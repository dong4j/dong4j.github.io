...
hexo.extend.filter.register('after_render:html', function (data) {
  ...
  const {
    ...
    title = "文章摘要",
    summaryStyle = "/postchat/css/postChatUser_summary.min.css",
  ...
  if (enableAI && enableSummary) {
    scriptSrc = "/postchat/js/postChatUser_summary.min.js";
  } else if (enableAI) {
    scriptSrc = "/postchat/js/postChatUser.min.js";
  } else if (enableSummary) {
    scriptSrc = "/postchat/js/tianli_gpt.min.js";
  } else {
    scriptSrc = "";
  }
